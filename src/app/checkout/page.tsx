...
export default function CheckoutPage() {
  ...
  if (!email.includes("@")) {
    setErro("Informe um e-mail v├ílido.");
    return;
  }
  ...
  if (cart.length === 0) {
    setErro("Seu carrinho est├í vazio.");
    return;
  }
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <div className="rounded-2xl border border-gray-800 bg-gray-950 p-6 md:p-8">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Essas informa├º├Áes ser├úo usadas para identificar
            ...
            <div className="mt-8 rounded-xl border border-blue-500/20 bg-blue-500/5 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-400">
                N├úo ├® necess├írio informar endere├ºo. Os produtos
                ser├úo disponibilizados digitalmente ap├│s a
                confirma├º├úo do pagamento.
              </p>
          ...
          <aside className="h-fit rounded-2xl border border-gray-800 bg-gray-950 p-6 lg:sticky lg:top-6">
            ...
            <p className="mt-4 text-center text-xs leading-5 text-gray-500">
              O pagamento ser├í integrado nas pr├│ximas etapas.
            </p>
